  ...
  <div class="popup-body">
    ...
    <van-popup v-model="show" position="bottom" :overlay="false">
      <div class="popup-box">
        ...
        <template v-else>
          <p class="text-2" v-show="type === '充值匹配成功'">请于10分钟内完成付款，否则将被取消</p>
          <p class="text-moeny" v-show="type === '充值匹配成功'">800.00<span class="symbol">CNY</span></p>

          <p class="text-2" v-show="type === '提现匹配成功'">{{ name | filterText }}</p>
