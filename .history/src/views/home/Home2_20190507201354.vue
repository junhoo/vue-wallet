...
import { encodeAesString, decodeAesString } from '@/assets/js/encryption.js'
...
export default {
  ...
  methods: {
    xxx () {
      ...
      const encode = encodeAesString(addstring, key, iv)
      console.log(encode, 1)
      const decode = decodeAesString(encode, key, iv)
    ...
    testAes () {
      ...
      var iv = '0798736492443041'
      const addstring = '6666666'
      const encode = this.getAesString(addstring, key, iv)
      console.log(encode)
      const decode = this.getDeAesString(encode, key, iv)
      console.log(decode)
    },
