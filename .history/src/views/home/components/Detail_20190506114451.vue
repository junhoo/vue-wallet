<template>
  ...
  <div class="main-detail">
    <div class="top-box"
      ...
      <span class="top-text">{{detailInfo.status | filterLeftState}}</span><span class="top-state">等待买家付款</span>
    </div>

    <div class="content-box">
      <div class="text-box-1">
        <span class="text-left">收款金额</span><span class="text-right">{{collectionMoney}}</span>
        <p class="text-symbol">CNY</p>
      </div>
      <div class="text-box-2">
        <span class="text-left">提现积分</span><span class="text-right">{{detailInfo.order_amount}}</span>
      </div>
      <div class="text-box-3" v-show="type === '充值'">
        <span class="text-left">收款方式</span><span class="text-right">{{detailInfo.pay_type | filterCollection}}</span>
      </div>
      <div class="text-box-4" v-show="type === '提现' || type === '未到账'">
