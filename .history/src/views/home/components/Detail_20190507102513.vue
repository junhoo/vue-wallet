<template>
  ...
  <div class="main-detail">
    <div class="top-box"
        :class="{
          'blue': detailInfo.a_status_str == '充值未到账' && detailInfo.order_type == 1,
          'skyblue': detailInfo.a_status_str == '匹配成功' || detailInfo.a_status_str == '重新匹配成功',
          'orange': (detailInfo.a_status_str == '未到账' && detailInfo.order_type == 2)
        }">
      ...
      <template>
        <span class="top-state">{{detailInfo.a_status_str | takeoutRightState}}</span>
      </template>
    </div>
    ...
    <div class="content-box">
      ...
      <div class="note-box" v-show="type === '提现未到账'">
        <p>1：买方已向您付款，请您核实收款信息</p>
        <p>2：如果您未收到买方付款，请勿点击下方“确认收款”按钮</p>
      </div>
      ...
      <div class="button-box-not" :class="{'button-top': === '充值未到账'}" v-show="type === '充值未到账'">
