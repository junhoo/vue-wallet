  ...
  <div class="main-detail">
    ...
    <div class="content-box">
      ...
      <div class="text-box-4" v-show="type === '充值' || type === '未到账'">
        ...
        <div v-if="detailInfo.choice_pay_type.includes('3') >= 0" class="icon-bank"></div>
        <div v-if="detailInfo.choice_pay_type.includes('2') >= 0" class="icon-wechat"></div>
        <div v-if="detailInfo.choice_pay_type.includes('1') >= 0" class="icon-alipay"></div>
      </div>
