      ...
      <div v-if="userCertifyMsg.status != 1" class="bottom">
        ...
        <div class="upload">
          <div class="imgs">
            ...
            <input style="border: 1px red solid;" class="inputpo1" type="file" accept="image/png, image/jpeg, image/jpg" @change="tirggerFile($event,1)">
          </div>
          <div class="imgs">
            <div v-show="cardUrl2 !== ''">
              <div class="mask">
            ...
            <input style="border: 1px blud solid;" class="inputpo2" type="file" @change="tirggerFile($event,2)">
          </div>
        </div>
